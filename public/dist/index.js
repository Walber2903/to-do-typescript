...
(function () {
    ...
    var Reminder = /** @class */ (function () {
        function Reminder(description, date, notifications) {
            ...
            this.dateUpdated = DateUtils.tomorrow();
            this.description = '';
    ...
    var todo = new Todo('Todo with class');
    var reminder = new Reminder('Description to reminder', new Date(), [NotificationPlatform.EMAIL]);
    var taskView = {
